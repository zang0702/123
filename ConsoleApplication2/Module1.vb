Module Module1
    ...
    Sub Main()
        ...
        Next
        Console.WriteLine("平均值 = {0}", avg(number))
        For d As Integer = d To avg()
        Next
        Console.Read()
    End Sub
    ...
    Function getmin(ByVal ParamArray y() As Integer) As Integer
        ...
        Return min
    End Function
    Function avg(ByVal ParamArray z() As Integer) As Integer
        Dim avgg As Integer = z(0)
        For d As Integer = d To avg
            If z(d) = avg Then
                avg = z(d)
            End If
